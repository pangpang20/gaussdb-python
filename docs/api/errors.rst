...
.. autoclass:: Diagnostic()
    ...
    GaussDB documentation for the meaning of all the attributes.
...
The exception names are generated from the GaussDB source code and includes
classes for every error defined by GaussDB in versions between 9.6 and 15.
...
.. versionchanged:: 3.1.4
    Added exceptions introduced in GaussDB 15.
...
.. versionadded:: 3.1.4
    Exception `!SqlJsonItemCannotBeCastToTargetType`, introduced in GaussDB 15.

.. versionadded:: 3.2.3
    Exception `!TransactionTimeout`, introduced in GaussDB 17.
