...
if _gaussdb:
    format_row_text = _gaussdb.format_row_text
    format_row_binary = _gaussdb.format_row_binary
    parse_row_text = _gaussdb.parse_row_text
    parse_row_binary = _gaussdb.parse_row_binary
