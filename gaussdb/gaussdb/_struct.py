...
def pack_float4_bug_304(x: float) -> bytes:
    raise e.InterfaceError(
        "cannot dump Float4: Python affected by bug #304. Note that the gaussdb-c"
        " and gaussdb-binary packages are not affected by this issue."
        " See https://github.com/gaussdb/gaussdb/issues/304"
    )
