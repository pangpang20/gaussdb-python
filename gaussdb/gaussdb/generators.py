...
if _gaussdb:
    connect = _gaussdb.connect
    cancel = _gaussdb.cancel
    execute = _gaussdb.execute
    send = _gaussdb.send
    fetch_many = _gaussdb.fetch_many
    fetch = _gaussdb.fetch
    pipeline_communicate = _gaussdb.pipeline_communicate
