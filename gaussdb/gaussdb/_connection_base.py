...
if TYPE_CHECKING:
    from gaussdb_pool.base import BasePool
...
class BaseConnection(Generic[Row]):
    ...
    def add_notice_handler(self, callback: NoticeHandler) -> None:
        ...
        :type callback: Callable[[~gaussdb.errors.Diagnostic], None]
        """
    ...
    def add_notify_handler(self, callback: NotifyHandler) -> None:
        ...
        :type callback: Callable[[~gaussdb.Notify], None]
        """
